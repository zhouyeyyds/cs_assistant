...
<template>
    <!-- ui待优化 -->
    <div class="fixed left-0 top-0 flex-col f-b-c p-0.625rem w-100% h-4.375rem text-1rem bg-white  navbar" >
      <p class="text-1.125rem text-[#35a1fc]">当前科目 :</p>
      <span class="text-[#35a1fc]">{{ namearr[index] }}</span>
    </div>
    <!-- 标签栏 -->
    <div class="fixed left-0 top-4.4375rem w-100% mt-0.0625rem mb-0.125rem shadow-sm" >
    ...
    <div class="mt-7.25rem f-b-c flex-col p-0.625rem bg-white h-32.25rem" >
      <!-- 练习进度条 -->
        <div class="m-y-1.25rem m-x-0.625rem" @click="gopractice">
        ...
        <!-- 测试进度条 -->
        <div class="m-y-1.25rem m-x-0.625rem" @click="showpop=true">
